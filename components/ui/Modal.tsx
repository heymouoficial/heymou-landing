...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div
        className={cn(
          'relative w-full mx-4 bg-white dark:bg-accent rounded-xl shadow-2xl transform transition-all',
...
const ModalHeader: React.FC<{ children: React.ReactNode; className?: string }> = ({
  ...
  <div className={cn('pb-4 border-b border-border dark:border-gray-700', className)}>
    {children}
  </div>
);
...
const ModalFooter: React.FC<{ children: React.ReactNode; className?: string }> = ({
  ...
  <div className={cn('pt-4 border-t border-border dark:border-gray-700 flex justify-end space-x-3', className)}>
    {children}
  </div>
);
